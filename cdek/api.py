...
from cdek.base import ApiResponseError, ApiResponseOrder, ApiResponse
...
class CDEKAPI(object):
    ...
    def make_status_report_request(self, status_report, method_url=u'status_report.php'):
        """
        Производит запрос на полчение статуса отправления
        :param basestring method_url:
        :param CDEKDeliveryRequest delivery_request:
        """
